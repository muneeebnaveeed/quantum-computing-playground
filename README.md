...
Python 3.11.3 in a conda env, run inside Docker so nothing has to be installed locally.
...
docker compose run --rm app pytest         # smoke test: Python 3.11.3 + deps import
```
